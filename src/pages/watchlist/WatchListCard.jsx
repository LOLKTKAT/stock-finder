...
const WatchListCard = ({ stock }) => {
  ...
  const STOCK_DATA_URL = `https://finnhub.io/api/v1/quote?symbol=${stock}&token=${API_KEY}`;
  const STOCK_DISCRIPTION = `https://finnhub.io/api/v1/stock/profile2?symbol=${stock}&token=${API_KEY}`;
          ...
          <>
            ...
            <section className="stock-card__row">
              <div className="stock-card__heading-container">
                <Link className="dark-link" to={`/details/${stock}`}>
